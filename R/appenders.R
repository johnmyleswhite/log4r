...
#' @description
#'
#' In [log4j](https://logging.apache.org/log4j/) etymology,
#' **Appenders** are destinations where messages are written. Depending on
#' the nature of the destination, the format of the messages may be controlled
#' using a **[Layout][layouts]**.
#'
...
#' `function(level, ...)`. These functions are expected to write their
...
#'
#' @seealso [tcp_appender()], [http_appender()],
#'   [syslog_appender()]
#'
#'
#' @name appenders
